...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Yak, Jangan lupa donasi :)',
			error: {
...
const daftar1 = `Hai kak  ${pushname} ${tampilUcapan} \n\nKamu belum terdaftar ke database Itsuki bot nih, yuk daftar dulu, pencet button di bawah ya`
const daftar2 = 'Bahagia Selalu kak ;)\njangan lupa donasi'
...
│❒  Jam : ${time}
└⬣
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)


THANKS TO :
1.MY TEAM (Yang membantu coding sc)
2.RADIT (Diriku)
3.Bagas
4.Arya
5.Penyedia apikey`
gam = fs.readFileSync('./zeroyt7/menubot.jpg')
but = [
          { buttonId: `${prefix}info`, buttonText: { displayText: 'ALL MENU' }, type: 1 },
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
        sendButImage(from, teks, "©Radit Ganz", gam, but)
break
...
costum(buffer, sticker, Verived, `Jangan Lupa Donasi`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Donasi' })
fs.unlinkSync(ran)
})
break
...
await zeroyt7.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Nih Jangan Lupa Donasi'})
break
case 'tiktok':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (args.length == 0) return reply(`Link Nya Mana Tod\nContoh: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
...
await zeroyt7.sendMessage(from, ini_buffer, video, { quoted: ftrol, caption: 'Nih Jangan Lupa Donasi'})
break
case 'tiktokmusic':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
await zeroyt7.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Donasi'})
break
//━━━━━━━━━━━━━━━[ FITUR ANIME ]━━━━━━━━━━━━━━━━━//
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Donasi Ya'})
})
break
case 'chiisaihentai':
case 'trap':
...
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Donasi Yak'})
break
case 'asupancecan':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Donasi'})
break
case 'asupanhijaber':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Donasi yaj'})
break
case 'asupansantuy':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Donasi Yaj'})
break
case 'asupanghea':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Donasi ya'})
break
...
zeroyt7.sendMessage(from, goo, image, {quoted: ftrol, caption: 'Nih Jangan Lupa donasi ya'})
break
case 'cecanmalaysia':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
reply(mess.wait)
goo = await getBuffer(huft.result.url)
zeroyt7.sendMessage(from, goo, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Donasi '})
break
case 'cecankorea':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Donasi'})
})
break
case 'randomdarkjoke':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
but = [
        ...
        sendButImage(from, teks, "©Itsuki Botz", gam, but)
break
case 'groupmenu':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
	teks =
...
┗━━━━━━━━━━━━━━❏
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)`
gam = fs.readFileSync('./zeroyt7/groupmenu.jpg')
but = [
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
...
┗━━━━━━━━━━━━━━❏
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)`
gam = fs.readFileSync('./zeroyt7/stickermenu.jpg')
but = [
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
...
┗━━━━━━━━━━━━━━❏
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)`
gam = fs.readFileSync('./zeroyt7/ownermenu.jpg')
but = [
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
...
┗━━━━━━━━━━━━━━❏
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)`
gam = fs.readFileSync('./zeroyt7/downloadmenu.jpg')
but = [
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
...
┗━━━━━━━━━━━━━━❏
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)`
gam = fs.readFileSync('./zeroyt7/anime.jpg')
but = [
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
...
┗━━━━━━━━━━━━━━❏
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)`
gam = fs.readFileSync('./zeroyt7/search.jpg')
but = [
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
...
┗━━━━━━━━━━━━━━❏
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)`
gam = fs.readFileSync('./zeroyt7/primbonmenu.jpg')
but = [
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
...
└❏
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)`
gam = fs.readFileSync('./zeroyt7/stalkmenu.jpg')
but = [
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
...
└❏
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)`
gam = fs.readFileSync('./zeroyt7/randomimg.jpg')
but = [
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
...
┗━━━━━━━━━━━━━━➤
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)`
gam = fs.readFileSync('./zeroyt7/asupan.jpg')
but = [
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
...
┗━━━━━━━━━━━━━━➤
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)`
gam = fs.readFileSync('./zeroyt7/cecan.jpg')
but = [
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
...
┗━━━━━━━━━━━━━━➤
BEBERAPA FILTUR MASIH EROR, MAKLUM MASIH CODING :)`
gam = fs.readFileSync('./zeroyt7/20211220_073828.jpg')
but = [
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
        ]
...
sendButton(from, "GOPAY : 085799850519 (Mikey)", faketeks, but, mek)
break
case 'dana':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
but = [
        ...
        sendButImage(from, kimak, "©Itsuki Botz", gam, but)
break
case 'donasi':
...
Semoga Rejekinya Tambah Lancar Amin
    ...
    ╭───────────────❏
❍┤ヅ Gopay : 085799850519
❍┤ヅ Dana : 085799850519
❍┤ヅ Pulsa : 085869002045
    ╰───────────────❏`
gam = fs.readFileSync('./zeroyt7/zerothumb.jpg')
but = [
          { buttonId: `${prefix}menu`, buttonText: { displayText: 'BACK TO MENU' }, type: 1 },
...
setTimeout( () => {
zeroyt7.sendMessage(from, ngebuff, image, { caption: '_Tebak bro!!! gak bisa jawab wajib donasi :v_', quoted: ftrol }) 
}, 0) // 1000 = 1s,
break
case 'tembak':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
